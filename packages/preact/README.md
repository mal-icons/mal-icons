...
| `@mal-icons/preact/la`            | All Line Awesome (named exports)      |
...
| `@mal-icons/preact/la/LaHeart`    | A single Line Awesome icon module     |
...
| `@mal-icons/preact/bx` | All Boxicons Regular icons (named exports) |
| `@mal-icons/preact/bx/BxAbacus` | A single Boxicons Regular icon module |
| `@mal-icons/preact/bxl` | All Boxicons Logos icons (named exports) |
| `@mal-icons/preact/bxl/BxlGithub` | A single Boxicons Logos icon module |
| `@mal-icons/preact/bxs` | All Boxicons Solid icons (named exports) |
| `@mal-icons/preact/bxs/BxsHeart` | A single Boxicons Solid icon module |
| `@mal-icons/preact/tb` | All Tabler icons (named exports) |
| `@mal-icons/preact/tb/TbHeart` | A single Tabler icon module |
| `@mal-icons/preact/ph` | All Phosphor icons (named exports) |
| `@mal-icons/preact/ph/PhHeart` | A single Phosphor icon module |
