/** Type-safe list of every icon name in the "io" set. */
export const ioIconNames = [
  "IoAccessibility",
...
/** Union of valid "io" icon names; invalid names are TS errors. */
export type IoIconName = (typeof ioIconNames)[number];
