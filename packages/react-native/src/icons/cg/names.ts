/** Type-safe list of every icon name in the "cg" set. */
export const cgIconNames = [
  "CgAbstract",
  "CgAdd",
  "CgAddR",
  "CgAdidas",
...
/** Union of valid "cg" icon names; invalid names are TS errors. */
export type CgIconName = (typeof cgIconNames)[number];
