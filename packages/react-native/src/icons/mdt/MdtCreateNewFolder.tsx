...
const MdtCreateNewFolder = createIcon("0 0 24 24", [["path",{"d":"m11.17 8-0.59-0.59L9.17 6H4v12h16V8h-8.83zM14 10h2v2h2v2h-2v2h-2v-2h-2v-2h2v-2z","opacity":".3"}],["path",{"d":"M20 6h-8l-2-2H4c-1.11 0-1.990.89-1.99 2L2 18c0 1.110.89 2 2 2h16c1.11 0 2-0.89 2-2V8c0-1.11-0.89-2-2-2zm0 12H4V6h5.17l1.41 1.410.590.59H20v10zm-8-4h2v2h2v-2h2v-2h-2v-2h-2v2h-2z"}]]);
