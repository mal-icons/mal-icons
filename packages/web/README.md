...
| `@mal-icons/web/la`                 | The Line Awesome set as a `{ name: IconData }` object |
...
| `@mal-icons/web/la/LaHeart.json`    | A single Line Awesome icon's JSON data                |
...
| `@mal-icons/web/ph` | All Phosphor icons (named exports) |
| `@mal-icons/web/ph/PhHeart.json` | A single Phosphor icon module |
