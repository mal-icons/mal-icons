...
| `@mal-icons/solid/gi`            | All Game Icons icons (named exports) |
...
| `@mal-icons/solid/gi/GiAce` | A single icon module              |
| `@mal-icons/solid/gr/GrHome` | A single icon module              |
| `@mal-icons/solid/io`            | All Ionicons (named exports)      |
| `@mal-icons/solid/la`            | All Line Awesome (named exports)      |
...
| `@mal-icons/solid/la/LaHeart`    | A single Line Awesome icon module     |
...
| `@mal-icons/solid/bs` | All Bootstrap Icons icons (named exports) |
| `@mal-icons/solid/bs/BsAlarm` | A single Bootstrap Icons icon module |
| `@mal-icons/solid/ri` | All Remix Icon icons (named exports) |
| `@mal-icons/solid/ri/RiHome2Line` | A single Remix Icon icon module |
| `@mal-icons/solid/si` | All Simple Icons icons (named exports) |
| `@mal-icons/solid/si/SiGithub` | A single Simple Icons icon module |
| `@mal-icons/solid/bx` | All Boxicons Regular icons (named exports) |
| `@mal-icons/solid/bx/BxAbacus` | A single Boxicons Regular icon module |
| `@mal-icons/solid/bxl` | All Boxicons Logos icons (named exports) |
| `@mal-icons/solid/bxl/BxlGithub` | A single Boxicons Logos icon module |
| `@mal-icons/solid/bxs` | All Boxicons Solid icons (named exports) |
| `@mal-icons/solid/bxs/BxsHeart` | A single Boxicons Solid icon module |
| `@mal-icons/solid/tb` | All Tabler icons (named exports) |
| `@mal-icons/solid/tb/TbHeart` | A single Tabler icon module |
| `@mal-icons/solid/ph` | All Phosphor icons (named exports) |
| `@mal-icons/solid/ph/PhHeart` | A single Phosphor icon module |
