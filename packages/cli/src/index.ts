...
Usage:
  ...
  mal-icon add <Name...> [--set <id>] [--framework <react|vue|svelte|preact|solid>] [--out <dir>]
  mal-icon licenses [--out <file>]
  mal-icon search <query...> [--semantic]
  mal-icon import <file.svg> --name <Name> [--framework <react|vue|svelte|preact|solid>] [--out <dir>]
...
async function runImportCommand(
  ...
  const ext = framework === "react" ? "tsx" : framework === "svelte" ? "svelte" : "ts";
