...
| `@mal-icons/vue/la`            | All Line Awesome (named exports)      |
...
| `@mal-icons/vue/la/LaHeart`    | A single Line Awesome icon module     |
...
| `@mal-icons/vue/bx` | All Boxicons Regular icons (named exports) |
| `@mal-icons/vue/bx/BxAbacus` | A single Boxicons Regular icon module |
| `@mal-icons/vue/bxl` | All Boxicons Logos icons (named exports) |
| `@mal-icons/vue/bxl/BxlGithub` | A single Boxicons Logos icon module |
| `@mal-icons/vue/bxs` | All Boxicons Solid icons (named exports) |
| `@mal-icons/vue/bxs/BxsHeart` | A single Boxicons Solid icon module |
| `@mal-icons/vue/tb` | All Tabler icons (named exports) |
| `@mal-icons/vue/tb/TbHeart` | A single Tabler icon module |
| `@mal-icons/vue/ph` | All Phosphor icons (named exports) |
| `@mal-icons/vue/ph/PhHeart` | A single Phosphor icon module |
