...
Flat Color Icons `fc`, Grommet `gr`, Heroicons `hi`, Simple Line Icons `sl`, css.gg `cg`, Codicons `vsc`, Themify `tf`, Radix Icons `rx`, Material Icons `md` —
14,714 icons) with tags and descriptions, a fast search script, per-framework
...
Circum (MPL-2.0), Typicons (CC-BY-SA-4.0), Weather Icons (OFL-1.1), Grommet (Apache-2.0), Material Icons (Apache-2.0).
