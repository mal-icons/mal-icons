 ...
 *
 * Usage:
 *   node search.js <query> [--set fi|ci|io|fa] [--limit N] [--json]
 *
 * Examples:
...
function printHelp() {
  process.stdout.write(
    [
      "Usage: node search.js <query> [--set fi|ci|io|fa] [--limit N] [--json]",
      "",
      "Search mal-icons by name, tags, or description.",
      "",
      "Options:",
      "  -s, --set <id>     Limit to one set (fi, ci, io, fa).",
