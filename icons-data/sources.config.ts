...
export const sources: Record<string, IconSource> = {
  ...
  bx: {
    ...
    // Upstream ships no release tags; pin to the 2.1.4 commit for reproducibility.
    ref: "9ffa9136e8681886bb7bd2145cd4098717ce1c11",
    iconDir: "svg/regular",
    style: "fill",
    // Every file is namespaced `bx-*.svg`; drop the redundant prefix.
    stripPrefix: "bx-",
  },
  bxs: {
    id: "bxs",
