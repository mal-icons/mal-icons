...
shared mal-icons gallery with live controls for size, color, and animation.

It uses the `@mal-icons/angular` adapter — standalone components that build a
...
- `import { FiActivity } from "@mal-icons/angular/fi"` — tree-shakeable, ahead-of-time
