...
//   import FiSearch from "@mal-icons/svelte/fi/FiSearch"; // per-icon default
//   import { FiSearch } from "@mal-icons/svelte/fi";      // set barrel (named)
//   import { FiSearch } from "@mal-icons/svelte";         // package root (named)
