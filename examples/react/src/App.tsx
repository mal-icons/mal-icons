...
export function App() {
  ...
  async function copyImport(name: string) {
    await navigator.clipboard?.writeText(
      `import { ${name} } from "@mal-icon/react/fi";`,
    );
    setCopied(name);
      ...
      <div className="page">
        <header className="hero">
          ...
          <p className="hero__subtitle">
            Tree-shakeable, ahead-of-time generated icons with a single,
            consistent API. Theme everything through context and override
            per-icon.
          </p>
          <a
        ...
        <footer className="footer">
          ...
          The full set ships 287 tree-shakeable modules.
        </footer>
      </div>
